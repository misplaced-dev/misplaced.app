...
function Sort({ onPress }) {
  ...
  return (
    <View style={{ position: 'absolute', backgroundColor: '#F5FCFF', height: 50, width: '45%', top: 190, left:10, borderWidth: 1, borderColor: '#171717', borderRadius: 20}}>
      <TouchableOpacity
